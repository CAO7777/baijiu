...
def load_and_preprocess_data():
    ...
    column_mapping = {
        '2. 性别': '性别', '3. 年龄': '年龄', '4. 职业': '职业',
        '5. 教育程度': '教育程度', '6. 收入区间': '收入区间', '7. 城市': '城市',
        ...
        '9. 饮酒频率': '饮酒频率', '10. 饮酒历史（酒龄）': '酒龄',
        '11. 期望单瓶价格区间': '白酒价格', '12. 香型类别': '香型', '22. 主要用途': '用途'
    }
        ...
        for report_id in sorted_dirs:
            ...
            try:
                ...
                if summary_file not in files:
                    summary_file = "summary_report.html" # 旧版或精简版
